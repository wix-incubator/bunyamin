...
describe('DetoxLogger', () => {
  ...
  /** @type {typeof import('../decorator/Bunyamin')} */
  let DetoxLogger;
  /** @type {import('../decorator/Bunyamin')[]} */
   ...
   * }} [opts]
   * @returns {import('../decorator/Bunyamin')}
   */
  function logger(opts = {}) {
    const { level = 'trace', overrideConsole = false, options } = opts;
    DetoxLogger = require('../decorator/Bunyamin');
  ...
  describe('- main functionality -', () => {
    ...
    it.each([
      ...
      l.warn({ origin: 'some-module/index.ts', stack: 'at index.ts:30:73' }, 'Warning message!');
  ...
  describe('- unhappy paths -', () => {
    ...
    it('should allow creating a logger without a config', async () => {
      const DetoxLogger = require('../decorator/Bunyamin');
